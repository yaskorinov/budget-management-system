...
* **Диаграммы**: заголовок по центру, толстое кольцо со скруглёнными углами
  ...
  конкретными суммами. Внутри сегмента иконка категории, снаружи — процент.
  Подпись привязана по направлению: растёт от кольца наружу, а не поперёк —
  с якорем по центру половина текста заходила на сегмент справа и слева, а
  сверху и снизу, наоборот, отходила далеко. Высота картинки подстраивается под число
