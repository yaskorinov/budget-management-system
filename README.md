...
* **Диаграммы**: заголовок по центру, толстое кольцо со скруглёнными углами
  ...
  конкретными суммами. Внутри сегмента иконка категории (для людей — первая
  буква имени), снаружи — процент. Высота картинки подстраивается под число
...
* Сегменты рисуются вручную (`_rounded_wedge`): у стандартного клина matplotlib
  ...
  Иконки растрирует Pillow — цветные эмодзи matplotlib не умеет; без шрифта с
  эмодзи в системе рисуется первая буква названия.
