...
и центр кольца покажет эту категорию. Тему берём из Telegram, а в браузере —
...
Рисованные иконки остались только в нижней панели: она сделана как на iOS —
стекло с размытием поверх контента, у выбранной вкладки залитая иконка
и подсветка. Эмодзи категорий приходят из API — те же, что бот шлёт в чат.
