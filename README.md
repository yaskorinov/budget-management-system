...
* **Диаграммы**: заголовок по центру, толстое кольцо со скруглёнными углами
  ...
  конкретными суммами и долей. Внутри сегмента — только иконка категории:
  подписи процентов снаружи кольца то налезали на него, то отходили слишком
  далеко, а внутри сегмента не помещались рядом с иконкой. Высота картинки подстраивается под число
