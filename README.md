...
* **Диаграммы**: заголовок по центру, кольцо с раздельными сегментами и суммой
  внутри, под ним — плашки категорий их же цветом с конкретными суммами. Высота
  картинки подстраивается под число плашек. Не больше шести сегментов (остальное
  сворачивается в «Другие»), проценты подписаны прямо на кольце — цвет никогда
  не единственный носитель смысла. Цвет текста на плашке выбирается по контрасту
