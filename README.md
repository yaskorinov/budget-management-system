...
из системной настройки. Шрифт Inter тот же, что и на картинках диаграмм,
только урезанный до нужных символов (три начертания, 66 КБ на все).
...
assets/fonts/            Inter: ttf для диаграмм, woff2-подмножество для веба
